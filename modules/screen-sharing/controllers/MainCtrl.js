...
App.controllers.screenShareCtrl = (function ($, App) {
    ...
    return function (options) {
        ...
        var call = null,
            ...
            // save screen share so we can show it to the caller
            screenVideo = null,
        ...
        function makeCall () {
            ...
            callOptions.previewLocalMedia = previewLocalMedia;
            endpoint.startScreenShare(callOptions);
        }
